...
interface Account {
  id: string;
  name: string;
  balance: number | string; // Handle potentially serialized decimals
  isDefault: boolean;
}
...
interface AddTransactionFormProps {
  ...
  categories: Category[];
  editMode?: boolean;
  initialData?: any; // Replace with proper Transaction interface if available
}
...
export function AddTransactionForm({
  ...
  if (editMode) {
    ...
    return updateTransaction(editId!, data);
  } else {
 ...
 const onSubmit = (data: any) => {
  ...
  // Now we always call it with just one argument
